...
class MDcView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        #ここにpy起動コマンド
        #使用するコマンドpirun -n 8 python MDCylinderFinal.py D5G Particle-Stokes.csv Electr(pyファイルでMPI要求されるから予めwindowsにダウンロードode-D5G.csv 1030 1000 50000 100 1000000 1 50 0　)
        command = [ "anaconda3.exe", "MDCylinderFinal.py", "D5G", "Particle-Stokes.csv", "Electrode-D5G.csv", "1030", "1000", "50000", "100", "1000000", "1", "50", "0", ]
