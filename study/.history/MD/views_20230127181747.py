...
class ecView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        #ここにshell起動コマンド
        command_b = ["./field.sh", "0", "1", "100", "Erectrode-D5G.csv",]
...
class MDcView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        #使用するコマンドpirun -n 8 python MDCylinderFinal.py D5G Particle-Stokes.csv Electrode-D5G.csv 1030 1000 50000 100 1000000 1 50 0　(pyファイルでMPI要求されるから予めwindowsにダウンロード)
