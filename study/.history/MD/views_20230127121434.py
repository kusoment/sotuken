...
class ecView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        #ここにshell起動コマンド
        subprocess.run(["field.sh","0", "1", "100", "Erectrode-D5G.csv"],)
        #os.system("field.sh 0 1 100 Erectrode-D5G.csv", shell=True)
        print("しゅうりょう！おめでとう！！！！")
        context = {
            'message':"終了しました",
        }
...
class MDcView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        command = ["mpirun", "-n", "8", "python", "MDCylinderFinal.py", "D5G", "Particle-Stokes.csv", "Electrode-D5G.csv", "1030", "1000", "50000", "100", "1000000", "1", "50", "0", ]
