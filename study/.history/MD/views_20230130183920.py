...
class efView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        shutil.move("Electrode-D5G.csv","D5G")
...
class ecView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        while x<y:
            ...
            print(V)
            command = ["mpiexec","-n","4", "python.exe","LaplaceCylElFuncFinal.py","3880", "1000", "500", "2000", "0.5", "200", "4", "1000", "20", "1", "0", "Electrode-D5G.csv", str(V)]
...
class MDcView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        command = ["mpiexec", "-n","4", "python.exe", "MDFlow.py", "D5G", "Particle-Flow-shusei-2.csv", "Electrode-D5G.csv", "1030", "1000", "50000", "100", "1000000", "1", "50", "0"]
