...
class ecView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        print(efView.post.X2)
        while x<y:
            print(x)
            V = 1000*(x/(z*2*3.14159265358979))
            print(V)
            command = ["mpiexec","-n","4", "python.exe","LaplaceCylElFuncFinal.py",X2, Y2, "500", "2000", "0.5", "200", "4", "500", "6", "1", "0", "D5G/Electrode-D5G.csv", str(V)]
...
class MDcView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        command = ["mpiexec", "-n","8", "python.exe", "MDFlow.py", "D5G", "Particle-Flow-shusei-2.csv", "Electrode-D5G.csv", "1040", "1000", "50000", "100", "1000000", "10", "50", "0"]
